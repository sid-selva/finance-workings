...
fluidRow(
  ...
  column(5,
  numericInput("w1", "Portf. %", 25, min = 0, max = 100))
)  
...
fluidRow(
  ...
  column(5,
  numericInput("w2", "Portf. %", 25, min = 0, max = 100))
)
...
fluidRow(
  ...
  column(5,
  numericInput("w3", "Portf. %", 20, min = 0, max = 100))
)
...
fluidRow(
  ...
  column(5,
  numericInput("w4", "Portf. %", 20, min = 0, max = 100))
)
...
fluidRow(
  ...
  column(5,
  numericInput("w5", "Portf. %", 10, min = 0, max = 100))
)

fluidRow(
  column(7,
  dateInput("date", "Starting Date", "2021-01-01", format = "yyyy-mm-dd"))
)
